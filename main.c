...
// substitui strdup para compatibilidade
...
int main(void) {
    ...
    // 2) Listagem após inserções
    printf("\n=== Conteúdo da Tabela Após Inserções ===\n");
    listar(t);

    // 3) Busca dinâmica com validação
    char nome_busca[50];
    while (1) {
    ...
    // 4) Remoção dinâmica com validação
    char nome_remove[50];
    while (1) {
    ...
    // 5) Listagem antes de finalizar
    printf("\n=== Conteúdo da Tabela Antes de Finalizar ===\n");
    listar(t);
